...
class GetEmployeeNumber(ProcessStep):
    ...
    def run(self,):
        ...
        employeeNumber = InputDialog.GetOperatorInput("Employee Number",prompt)
...
class CleanupProcessStep(ProcessStep):
    ...
    def run(self, ):
        ...
        try:
            ...
            self.station_driver = self.get_station_variable('Driver_System_Station.StationDriver.Driver')
            cycleCount = self.station_driver.IncrementCycleCount( "CycleCount" % (self.getChassisId()+1), "Griffith%d" % self.station_id )
