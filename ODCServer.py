...
class ODCServer(object):
    ...
    #---------------- Chaitud added 7-Apr-2020 -----------------#
    # Get TLA sn from ODC server
    # https://cthmes54.asia.ad.celestica.com/des/ELM/getparameter.asp?profile=GET_TLA&SN=PPCCTH201300201
    def getTlaSn(self,pcbaSN):
        print ">>> checking TLA SN"
        self.connect(self.cthmes)
        if self.requestData('/des/'+self.businessUnit+'/getparameter.asp?profile=GET_TLA&SN='+pcbaSN,'GET'):
            return self.ODCDataValue
            #print "ODC return value is:",ODCDataValue
    #---------------- Chaitud added 7-Apr-2020 -----------------#
