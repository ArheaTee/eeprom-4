                    ...
                    if boardType in ["Chabot","Hale","Griffith","Fenton","Kepler"]:
                        ...
                        while True:
                            ...
                            if serial_num == station._current_process_plan.variables["board_serial_number"]:
                                ...
                                #This step is for checking current station before test
                                serNum = serial_num                                         #Chaitud add 20-Feb-2019
                                status, msg = ck_stn.checkStation(serNum)        #Chaitud add 20-Feb-2019    
                                if not status:                                                     #Chaitud add 20-Oct-2019   
                                    self.set_fail("checkStation", msg )                   #Chaitud add 20-Feb-2019 
                                    return ProcessStatus.ABORTED                      #Chaitud add 20-Feb-2019 
