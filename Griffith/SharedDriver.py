...
class Driver(object):
    ...
    def ProcessConfigurationFile(self):
        ...
        try:
            self._config.read(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Griffith.cfg'))  # Read in the Config File
            ...
            err = 'The Following Error Occured Reading the Lowel2/Lowel2.cfg File '
